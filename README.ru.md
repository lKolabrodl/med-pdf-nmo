...
| --- | ---: | ---: | ---: |
| Все keyed cases | `74.23%` (`1933/2604`) | `81.93%` (`1437/1754`) | `58.35%` (`496/850`) |
...
Принятое исправление comparator-чисел изменило ровно один dev-набор из неправильного в правильный (`404 -> 405/523`) и не изменило ни одного holdout-набора. Замороженный holdout проходит gate `0.80`, но исторически уже использовался для анализа, поэтому это regression suite, а не слепая оценка обобщения.
