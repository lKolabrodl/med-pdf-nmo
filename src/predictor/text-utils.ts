 ...
 * `X-терапия` / `X терапия` / `терапия X`, где смысл почти тождественный.
 * Более контекстные группы не добавляются, чтобы не усиливать варианты,
 * которые встречаются рядом с противопоказаниями или условиями назначения.
 */
